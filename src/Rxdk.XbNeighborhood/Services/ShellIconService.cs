...
namespace Rxdk.XbNeighborhood.Services;
...
public static class ShellIconService
{
    ...
    public static IImage? GetNeighborhoodIcon() => LoadAsset("xbox-light.ico");
    ...
    private static IImage? LoadAsset(string fileName)
    {
        ...
        try
        {
            var uri = new Uri($"avares://xbneighborhood/Assets/{fileName}");
