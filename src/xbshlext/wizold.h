## # ## #THIS FILE IS FOR ARCHIVAL PURPOSES## #CAddConsoleData Has been changed extensively, and I just wanted to preserve the code## #somewhere.The major cause of the change is that this version of the Add New Console## #wizard allowed adding more than one Xbox at a time, the new wizard does not allow this.## #
