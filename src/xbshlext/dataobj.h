...
// CXboxDataObject
//------------------------------------------------------------------------
class ATL_NO_VTABLE CXboxDataObject : public CComObjectRootEx<CComMultiThreadModel>,
                                      ...
                                      public IDataObject
{
  ...
  public:
    ...
    **  c'tor and d'tor
    */
    CXboxDataObject() : m_pSelection(NULL),
