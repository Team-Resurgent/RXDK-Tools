...
{
  public:
    CXboxPropertySheet() : m_uMaxPages(0),
                           m_uPageCount(0),
                           m_pPages(NULL),
  ...
  private:
    static DWORD WINAPI ThreadProcStart(LPVOID pvThis)
    {
        return ((CXboxPropertySheet *)pvThis)->ThreadProc();
    }
    DWORD ThreadProc();
...
--*/
{
  public:
    CVolumeGeneralPage(
        ...
        UINT uVolumeType,
        BOOL fDriveOnTab) : m_ullTotalSpace(ullTotalSpace), m_ullFreeSpace(ullFreeSpace),
...
--*/
{
  ...
  protected:
    ...
    static DWORD WINAPI StartThreadProc(PVOID pvThis)
    {
        return ((CFSItemGeneralPage *)pvThis)->ThreadProc();
    }
    DWORD ThreadProc();
