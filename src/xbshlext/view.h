...
//-------------------------------------------------------------------------------
class ATL_NO_VTABLE CXboxViewCB : public CComObjectRootEx<CComMultiThreadModel>,
                                  public CShellObjectWithSite,
                                  public IShellFolderViewCB CTRACKABLEOBJECT
{
  public:
    /*
  ...
  public:
    ...
    */
    ...
    HRESULT OnSize(LONG x, LONG y)
    {
        return SetStatusParts();
    }

    HRESULT OnMergeMenu(LPQCMINFO pqcm)
    {
        return S_OK;
    }
    HRESULT OnUnMergeMenu(HMENU hMenu)
    {
        return S_OK;
    }
    ...
    */
    ...
    CXboxViewCB() : m_pXboxFolder(NULL)
    {
        INIT_TRACKABLEOBJECT_NAME(CXboxViewCB);
    }
    ~CXboxViewCB()
    {
        if (m_pXboxFolder)
            m_pXboxFolder->Release();
    }
