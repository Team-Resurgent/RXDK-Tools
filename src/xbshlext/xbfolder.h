...
//-------------------------------------------------------------------------------
class ATL_NO_VTABLE CXboxFolder : public CComObjectRootEx<CComMultiThreadModel>,
                                  public IShellFolder2,
                                  public IPersistFolder2 CTRACKABLEOBJECT
{
  ...
  public:
    ...
    */
    ...
    inline LPCSTR GetNamePtr()
    {
        return m_pszPathName;
    }
    inline LPCSTR GetPathNamePtr()
    {
        return m_pszName;
    }
    inline void GetName(OUT LPSTR pszName)
    {
        strcpy(pszName, m_pszName);
    }
    inline void GetPath(OUT LPSTR pszPath)
    {
        strcpy(pszPath, m_pszPathName);
    }
    inline void GetName(OUT LPWSTR pwszName)
    {
        Utils::CopyAtoW(pwszName, m_pszName);
    }
    inline void GetPath(OUT LPWSTR pwszPath)
    {
        Utils::CopyAtoW(pwszPath, m_pszPathName);
    }
    inline UINT GetPathLen()
    {
        return m_uPathLen;
    }
    inline ULONG GetShellAttributes()
    {
        return m_ulShellAttributes;
    }
    ...
    */
    inline void InvalidateChildList()
    {
        m_fChildrenValid = FALSE;
    }
    void GetSelectShellAttributes(IN OUT ULONG *pulShellAttributes);
    inline DWORD GetVerbsForSelection()
    {
        return m_fSelectionClone ? m_dwSelectionVerbs : 0;
    }
    ...
    ** Column Details
    */
    virtual HRESULT GetColumnHeaderDetails(IN UINT iColumn, OUT SHELLDETAILS *pShellDetails)
    {
        return E_NOTIMPL;
    }
    virtual HRESULT GetDetails(IN LPCITEMIDLIST pidl, UINT iColumn, OUT SHELLDETAILS *pShellDetails)
    {
        return E_NOTIMPL;
    }
    virtual HRESULT GetColumnSCID(IN UINT iColumn, OUT SHCOLUMNID *pscid)
    {
        return E_NOTIMPL;
    }
    ...
    */
    ...
    virtual IXboxConnection *GetXboxConnection()
    {
        return NULL;
    }
...
class CXboxVolume : public CXboxFileSystemFolder
{
  public:
    ...
    ** Construction
    */
    CXboxVolume::CXboxVolume()
    {
        INIT_TRACKABLEOBJECT_NAME(CXboxVolume);
        m_dwSelectionVerbs = VOLUME_VERBS;
    }
    static HRESULT Create(
        LPCSTR pszPathName,
        LPCITEMIDLIST pidlRoot,
...
class CXboxDirectory : public CXboxFileSystemFolder
{
  public:
    ...
    ** Construction
    */
    CXboxDirectory::CXboxDirectory()
    {
        INIT_TRACKABLEOBJECT_NAME(CXboxDirectory);
        m_dwSelectionVerbs = DIRECTORY_VERBS;
    }
    static HRESULT Create(
        LPCSTR pszPathName,
        LPCITEMIDLIST pidlRoot,
